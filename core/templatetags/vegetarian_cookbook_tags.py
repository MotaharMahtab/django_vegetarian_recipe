...
@register.inclusion_tag('templatetags/categories_list.html')
...
@register.inclusion_tag(
    'templatetags/categories_icons.html')
def categories_icons(a_class):
    """ show categories list as icons """
    categories = Category.objects.all()
    return {'categories': categories, 'a_class': a_class}

@register.inclusion_tag('templatetags/tags_list.html')
def tags_list(a_class):
    """ show categories list as icons """
    tags = Tag.objects.all()
    return {'tags': tags, 'a_class': a_class}


@register.inclusion_tag(
    'templatetags/ingredients_list.html')
...
@register.inclusion_tag(
    'templatetags/recipe_cooking_time.html')
