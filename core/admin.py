...
from .models import RecipeIngredient, RecipeImage, Order, OrderItem
...
class IngredientAdmin(admin.ModelAdmin):
    ...
    admin_thumbnail = AdminThumbnail(image_field='thumbnail')
    admin_thumbnail.short_description = _('Thumbnail')
    fields = ('generate_url', 'name', 'image', 'description','slug',
    ...
    def generate_url(self, obj):
        ...
        return format_html(LINK_HTML,
                           reverse('core:recipes_ingredient', args=(obj.name,obj.slug,)),
                           obj.name)
...
class RecipeAdmin(admin.ModelAdmin):
    ...
    form = RecipeForm
    list_display = ('admin_thumbnail', 'title','price','status_url', 'fullness',
                    'category', 'recipe_tags', 'recipe_ingredients','slug')
    ...
    fieldsets = (
        (None, {
            'fields': ('owner','title',('price','discount_price'),'slug', ('status', 'label','generate_url'),
                       ('complexity', 'category'),
    ...
    readonly_fields = ('generate_url', 'status_url','owner',)
    admin_thumbnail = AdminThumbnail(image_field='thumbnail')
    admin_thumbnail.short_description = _('Thumbnail')
    ...
    def generate_url(self, obj):
        ...
        if not obj.url:
            return '???'
        url = reverse('core:recipes_recipe', args=(obj.url,obj.slug))
    ...
    def status_url(self, obj):
        ...
        return format_html(LINK_HTML,
                           reverse('core:recipes_recipe', args=(obj.url,obj.slug)),
