...
class Ingredient(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("core:recipes_ingredient", kwargs={'slug': self.slug,'ingredient_name':self.name})
...
class Recipe(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL,
                             on_delete=models.CASCADE, related_name='recipes_created')
    ...
    manually_weight = models.IntegerField(default=None, null=True, blank=True,
                                          verbose_name=_('manually_weight'),
    ...
    def get_absolute_url(self):
        return reverse("core:recipes_recipe", kwargs={'slug': self.slug,'recipe_name':self.url})

    def get_add_to_cart_url(self):
        return reverse('core:add-to-cart', kwargs={'slug': self.slug,'recipe_name':self.url})

    def get_remove_from_cart_url(self):
        return reverse('core:remove-from-cart',kwargs={'slug': self.slug,'recipe_name':self.url})
